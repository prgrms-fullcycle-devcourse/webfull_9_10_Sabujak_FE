    ...
    <div ref={ref}>
      ...
      >
        <section className="w-full released">
          <h2 className="mt-2 text-center text-[16px] text-gray-400">
            {room.title}
          </h2>
          <div
            id="released-capsule-heading"
            className="mt-3 text-center text-[26px] font-extrabold leading-snug text-gray-900"
          >
            드디어 상자가
            <br />
            열렸습니다.
          ...
          <div className="mt-8 grid max-w-md grid-cols-2 gap-4">
            {room.messages.map((msg, index) => (
              ...
              >
                ...
                <p className="flex flex-1 items-center justify-center break-keep whitespace-pre-line text-center text-[18px] font-semibold leading-relaxed text-gray-700">
                  {msg.content}
                </p>
              </div>
            ))}
